...
def index():
    ...
    stats = {
        ...
        'rev_table' : df2.pivot_table(index=['Category','App','Rating'],values='Reviews',aggfunc='sum').sort_values(by='Reviews',ascending=False).reset_index().head(10).to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
